...
import { CheckSquare, Link, Paperclip, Waypoints } from "lucide-react";
...
import { IssueChecklistActionButton } from "./checklist";
        ...
        <IssueChecklistActionButton
          ...
          customButton={
            <IssueDetailWidgetButton
              ...
              icon={<CheckSquare className="h-3.5 w-3.5 flex-shrink-0" strokeWidth={2} />}
              disabled={disabled}
            />
          }
          disabled={disabled}
